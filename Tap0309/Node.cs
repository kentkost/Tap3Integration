...
public class Node 
{
    ...
    public string DiplayValue { get => IsLeaf ? typeName +" : "+convertedValue : typeName; }
    ...
    public string StringRepresentationValue { get => convertedValue; set => convertedValue = value; }
